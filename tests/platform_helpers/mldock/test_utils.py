...
class TestUtils:
    ...
    sample_environment = {"run_id": 2, "A_DUMMY_CONDITIONAL": True}
    ...
    sample_hyperparameter_validation = {
        "MLDOCK_HYPERPARAMETERS": '{"factors": 10, "Alpha criterion": "gini", "weighting": {"A": 10, "C": 2}}'
    }

    sample_collected_mldock_env_vars = {
        "MLDOCK_ENVIRONMENT": '{"run_id": 2, "A_DUMMY_CONDITIONAL": true}',
        "MLDOCK_HYPERPARAMETERS": '{"factors": 10, "Alpha criterion": "gini", "weighting": {"A": 10, "C": 2}}',
        "MLDOCK_STAGE": "dev",
    }
    ...
    def test_format_dictionary_as_env_vars(self):
        ...
        assert (
            result == self.sample_hyperparameter_validation
    ...
    def test_collect_mldock_environment_variables(self):
        ...
        assert (
            result == self.sample_collected_mldock_env_vars
        ), "Failed, Keys were not in MLDOCK format"
