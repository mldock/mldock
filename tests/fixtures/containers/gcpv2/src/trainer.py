...
from mldock.platform_helpers.mldock.model_service.decorators import trainer
from src.container.assets import environment, logger, TrainingContainer

@trainer(container=TrainingContainer, environment=environment, logger=logger)
def run_training():
